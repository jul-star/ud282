...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        String result = "None";
        if( CheckRows(grid, 'x') || CheckCols(grid, 'x') ||  CheckDiag1(grid, 'x') || CheckDiag2(grid, 'x'))
        {
            result = "X wins";
        }
        else if(CheckRows(grid, 'o') || CheckCols(grid, 'o') ||  CheckDiag1(grid, 'o') || CheckDiag2(grid, 'o'))
        {
            result = "O wins";
        }
        else if(freeSpots == 0)
    ...
    private boolean CheckRows(char[][] grid, char ch)
    {
        boolean vRow = true;
        int res = 0;
        for (int c = 0; c < 3; ++c)
    ...
    private boolean CheckCols(char[][] grid, char ch)
    {
        boolean vRow = true;
        int res = 0;
        for (int r = 0; r < 3; ++r)
    ...
    private boolean CheckDiag1(char[][] grid, char ch)
    {
        char col = grid[0][0];
        boolean vRow = true;
        int res = 0;
    ...
    private boolean CheckDiag2(char[][] grid, char ch)
    {
        char col = grid[0][0];
        boolean vRow = true;
        int res = 0;
